    ...
    <div className="hot-business-container">
      <div className="business-card">
        <div>
          ...
          <div className="business-card-content">
            <h3><Link className="card-title" to={`/businesses/${props.businesses[0].id}`}>{props.businesses[0].business_name}</Link></h3>  
      ...
      <div className="business-card">
        <div>
          ...
          <div className="business-card-content">
            <h3><Link className="card-title" to={`/businesses/${props.businesses[1].id}`}>{props.businesses[1].business_name}</Link></h3> 
            <p>Donuts, Dessert</p>
            <p>San Jose</p>
      ...
      <div className="business-card">
        <div>
          ...
          <div className="business-card-content">
            <h3><Link className="card-title" to={`/businesses/${props.businesses[2].id}`}>{props.businesses[2].business_name}</Link></h3> 
